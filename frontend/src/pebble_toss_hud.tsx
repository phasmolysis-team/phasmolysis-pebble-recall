...
export function ThrowHUD({
	...
	return (
		<>
			<LiveMessagePopup show={true} message="How energetic do you feel?" />

			<button className="topRightXButton_topRight" onClick={returnToPondHUD}>
				x
			</button>
...
function EnergyBar({ verticalValue, setVerticalValue }: EnergyBarProps) {
	...
	return (
		<>
			<HamburgerMenu
				...
				openSideEffectJournal={openSideEffectJournal}
			/>
...
function HamburgerMenu({
	...
	return (
		<div style={styles.topRightContainer}>
			<button style={styles.hamburgerButton} onClick={() => setOpen(!open)}>
				<img
					src={hamburgerIcon}
...
function NewRockButton({ openNewRockMenu = () => {} }) {
	...
	return (
		<button style={styles.floatingButton} onClick={openNewRockMenu}>
			<img
				src={addRockIcon}
				alt="Button Image"
