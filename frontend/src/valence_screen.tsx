...
export function ValenceScreen({
	dismissValenceScreenAndReopenHUD,
	hat,
	eyes,
	base,
	setTintFromValence,
	...
	const startHorizontalDrag = (e: MouseEvent | TouchEvent): void => {
		e.preventDefault();
		...
		<div id="valenceBackground" style={styles.valenceBackground}>
			<div style={styles.valenceScreen}>
				<button
					...
					onClick={() => dismissValenceScreenAndReopenHUD("pond")}
				>
					x
				</button>
				...
				<RockComposite
					...
					eyes={eyes}
					base={base}
					tint={`rgb(${currentColor.r}, ${currentColor.g}, ${currentColor.b})`}
				/>
				...
				<div style={styles.horizontalSection}>
					<div
						...
						onMouseDown={(e) => startHorizontalDrag(e.nativeEvent)}
						onTouchStart={(e) => startHorizontalDrag(e.nativeEvent)}
					>
						<div
							style={{
				...
				<button
					...
					onClick={takeValenceAndGoToEnergyBarScreen}
				>
					next
				</button>
			</div>
...
const styles: Record<string, any> = {
	...
	horizontalBar: {
		...
		height: "50px",
		background:
			"linear-gradient(90deg,rgba(31, 154, 194, 1) 0%, rgba(243, 180, 56, 1) 100%)",
		overflow: "hidden",
		position: "relative",
		cursor: "pointer",
